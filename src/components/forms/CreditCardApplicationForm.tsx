...
const creditCardSections = [
  ...
  },
  {
    ...
    fields: [
        { name: "addressDetails.currentAddress", label: "Residential Address", type: "textarea", placeholder: "Full residential address", colSpan: 2 },
    ]
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "documentUploads.existingCreditCardStatement", label: "Existing Credit Card Statement (if any)", type: "file", colSpan: 2, accept: ".pdf,.jpg,.jpeg,.png" },
    ]
  }
];
