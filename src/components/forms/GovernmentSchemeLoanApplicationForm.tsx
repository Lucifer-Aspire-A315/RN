...
const governmentSchemeSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "documentUploads.businessProof", label: "Business Proof (Udyam / Registration)", type: "file", colSpan: 2, accept: ".pdf,.doc,.docx,.jpg,.jpeg,.png" },
      ...
      { name: "documentUploads.casteCertificate", label: "Caste Certificate (if applicable)", type: "file", colSpan: 2, accept: ".pdf,.jpg,.jpeg,.png" },
      { name: "documentUploads.incomeCertificate", label: "Income Certificate", type: "file", colSpan: 2, accept: ".pdf,.doc,.docx,.jpg,.jpeg,.png" },
      { name: "documentUploads.projectReport", label: "Project Report / Business Plan", type: "file", colSpan: 2, accept: ".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png" },
